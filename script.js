...
box2Img.src = "box1_image.png";
box3Img.src = "box1_image.png";
let boxesArray = [];
let boxSpeed = -8; 
...
function createBoxWithRandomInterval() {
    ...
    let randomTime = rnd(1000, 2500); // Set เวลา 1000 คือ 1 วิ
...
function update() {
    ...
    for (let index = 0; index < boxesArray.length; index++) {
        ...
        if (onCollision(player, box)) {
            ...
            context.font = "normal bold 40px Arial"; // Set font
